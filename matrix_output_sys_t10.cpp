...
int I_checking(int matrix[12][22][4]);
int row_checking(int matrix[12][22][4]);
void row_erasing(int matrix[12][22][4],int row);
...
int main()
{
    ...
    {   
        ...
        if (recode5block(matrix, recodedblock_3, kernel2) == 0)
        {
            ...
            check=row_checking(matrix);
         while(check!=0){
            row_erasing(matrix,row_checking(matrix));
            check=row_checking(matrix);
          }
           
            ran=rand()%7;
            shapeofyou = set7blocks(matrix, ran);
           matrixequa(matrix, matrix_t);
...
int I_rotation(int matrix[12][22][4], int matrix_t[12][22][4], int mode)
{
    ...
    if (b[1] == 0)
    {
        ...
        {
            matrix[a[0]][a[1]][i] = 0;
            matrix[a[0]][a[1]+2][i] = 0;
            matrix[a[0]][a[1]+3][i] = 0;
        }
        matrix[a[0] -2][a[1] +1][0] = 3;
        matrix[a[0] -1][a[1] +1][0] = 3;
        matrix[a[0] +1][a[1] +1][0] = 3;

        matrix[a[0] -2][a[1] +1][1] = 1;
        matrix[a[0] -1][a[1] +1][1] = 1;
        matrix[a[0] +1][a[1] +1][1] = 1;

        matrix[a[0] -2][a[1] +1][2] = 1;
        matrix[a[0] -1][a[1] +1][2] = 1;
        matrix[a[0] +1][a[1] +1][2] = 1;

        matrix[a[0] - 2][a[1] +1][3] = 1;
        matrix[a[0] + 1][a[1] +1][3] = 1;
        matrixequa(matrix, matrix_t);
...
int I_checking(int matrix[12][22][4]){
    ...
    if(b[1]==0)//level
    {
        if(matrix[a[0]+2][a[1]-1][1]!=0)
        v++;
        if(matrix[a[0]+2][a[1]+1][1]!=0)
        v++;
        if(matrix[a[0]+2][a[1]+2][1]!=0)
        v++;
    }
    else if(b[0]==0)//perpendicular
    {
        if(matrix[a[0]-2][a[1]+1][1]!=0)
        v++;
        if(matrix[a[0]-1][a[1]+1][1]!=0)
        v++;
        if(matrix[a[0]+1][a[1]+1][1]!=0)
        v++;
    }
...
void row_erasing(int matrix[12][22][4],int row){
    ...
    for(;row>1;row--){
        for(int i=1;i<11;i++){
            for(int j=0;j<4;j++){
           matrix[i][row][j]=matrix[i][row-1][j];
        } 
        }
    }
}
