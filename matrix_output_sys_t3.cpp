...
void blocks_collision_test(int matrix[12][22][3], int matrix_t[12][22][3], int checking_instruction);
int recode4block(int matrix[12][22][3], int recodedblock_1[4][5]);
void matrixequa(int matrix[12][22][3], int matrix_t[12][22][3]);//let latter matrix equal to former
...
int main()
{
    ...
    for (int j = 0; ; j++)
    {
        ...
        blocks_collision_test(matrix, matrix_t, getkeyboard());
        matrix_output(matrix);
